import { truncateWithElipses } from './js/utils.js';

// Max number of characters allowed into a title of a source (when displaying a thumbnail)
...
localVideo.parentElement.addEventListener('mouseenter', (e) => { toggleControlBarVisibility(e, true); });
remoteVideo.parentElement.addEventListener('mouseenter', (e) => { toggleControlBarVisibility(e, true); });

localVideo.parentElement.addEventListener('mouseleave', (e) => { toggleControlBarVisibility(e, false); });
remoteVideo.parentElement.addEventListener('mouseleave', (e) => { toggleControlBarVisibility(e, false); });

function toggleControlBarVisibility(e, isVisible) {
...
// Returns the control bar for a given the videoElementId
...
/** Creates a thumbnail card representing a given source
...
function addThumbnails(source) {
  ...
  thumbnailTitle.textContent = truncateWithElipses(source.name, MAX_TITLE_LENGTH);
